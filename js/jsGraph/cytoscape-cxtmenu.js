;(function( $ ){ 'use strict';
  ...
  var defaults = {
    ...
    activeFillColor: 'rgba(255, 120, 120, 0.75)', // the colour used to indicate the selected command
  ...
  var register = function( cytoscape, $ ){
    ...
    cytoscape('core', 'cxtmenu', function(params){
      ...
      var target;
      var id_numerico = options.selector.slice(1); 
	  ...
	  $wrapper.addClass('node_'+id_numerico);
      $parent.css({
      ...
      for( var i = 0; i < commands.length; i++ ){
        ...
        var $content = $('<div class="cxtmenu-content ' + command.functions + '_' + id_numerico + '">' + command.content + '</div>');
        $content.css({
          'width': r * 0.66,
          'height': r * 0.66,
